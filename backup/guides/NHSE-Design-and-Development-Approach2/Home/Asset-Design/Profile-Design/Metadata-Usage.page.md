...
<table class="assets">
  ...
  <tbody>
    <tr>
        ...
        <td>1..1</td>
        <td>id</td>
         <td>In the NHS England IG the format in the following, with the FHIRAssetName and Specialism in PascalCase:<br/><br/><code>England-<i>[FHIRAssetName]</i></code>.</td>
    </tr>
    </tbody>
</table>
...
<table class="assets">
  ...
  <tbody>
    <tr>
        ...
        <td>1..1</td>
        <td>uri</td>
        <td>In the NHS England IG the format is the following, with the FHIRAssetName and Specialism in PascalCase:<br/><br/><code>https://fhir.nhs.uk/StructureDefinition/England-<i>[FHIRAssetName]</i></code>.</td>
    </tr>
    <tr>
        <td>identifier</td>
        <td>0..*</td>
    ...
    <tr>
        ...
        <td>1..1</td>
        <td>string</td>
        <td>In the NHS England IG the format is PascalCase:<br/><br/><code>England<i>[FHIRAssetName]</i></code> .</td>
    </tr>
    <tr>
        <td>title</td>
        <td>0..1</td>
        <td>1..1</td>
        <td>string</td>
        <td>In the NHS England IG the format is Proper Case:<br/><br/><code>England<i> [FHIRAssetName]</i><code>.</td>
    </tr>
    <tr>
        <td>status</td>
        <td>1..1</td>
